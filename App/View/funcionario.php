...
use App\Controller\funcionario\insert;
use App\Controller\funcionario\read;
use App\Controller\funcionario\delete;
            ...
            <div class="area-apresentacao ap-produtos">
                ...
                <section class="section-pag-produto">
                    <header class="cabecalho-section cabecalho-section-view">
                        ...
                        <h1 class="titulo-section">visualizar <span class="dif-style">funcionario(s)</span></h1>
                    </div>
